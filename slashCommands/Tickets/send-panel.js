module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .setFooter({ text: 'Wampas™ • Ticket Tool', iconURL: 'https://cdn.discordapp.com/attachments/939720531492605963/957398338976755802/wumpus_copy_2.pnga.png' })
